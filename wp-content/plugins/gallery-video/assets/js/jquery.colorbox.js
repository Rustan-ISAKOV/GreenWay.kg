...
(function ($, document, window) {
	...
	publicMethod.close = function () {
		...
		if(jQuery('#main-slider_'+lightbox_obj.galleryVideoID)[0]){
			var api = jQuery.data( jQuery('#main-slider_'+lightbox_obj.galleryVideoID)[0], 'liquidSlider');
			setTimeout(function(){
					api.startAutoSlide();
